			...
			function findOrderInfoByOid(oid){
				...
				$.post(
					...
					function(data){
						...
						/*[
						 * 	{"shop_price":4499.0,"count":2,"pname":"小米8","pimage":"products/1/c_0034.jpg","subtotal":8998.0},
						 *  {"shop_price":2599.0,"count":1,"pname":"小米平板","pimage":"products/1/c_0010.jpg","subtotal":2599.0}
						 *]*/
